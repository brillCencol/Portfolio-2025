...
const Work = ({isDarkMode}) => {
  return (
    ...
    id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      Welcome to my web development portfolio! Here, you’ll find projects I’m building as a student and aspiring full stack developer, exploring both front-end and back-end technologies.</motion.p>
